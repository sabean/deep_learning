...
class KeypointModel(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.dropout_1(self.maxpool_1(self.elu1(self.conv_1(x))))
        x = self.dropout_2(self.maxpool_2(self.elu2(self.conv_2(x))))
        x = self.dropout_3(self.maxpool_3(self.elu3(self.conv_3(x))))
        x = self.dropout_4(self.maxpool_4(self.elu4(self.conv_4(x))))
        
        x = x.view(x.shape[0],-1)
        x = self.dropout_5(self.elu5(self.dense_1(x)))
